        ...
        <header className="bg-white border-b border-gray-100 sticky top-0 z-50">
            <div className="container px-4 mx-auto">
                <div className="flex items-center justify-between h-16">
                    {/*log*/}
                    <Link to={mainPath.home.main} className="flex items-center gap-3">
              ...
              BulkTrade
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        >
                            ...
                            <span
                                className="absolute top-1 right-1 w-4 h-4 bg-[#00D4AA] text-white text-[10px] font-bold rounded-full flex items-center justify-center">
                3
              </span>
                        </Link>
                ...
                5
                        ...
                        {isAuthenticated ? (
                            <div className="flex items-center gap-3">
                                {/* User Info */}
                                <div
                                    className="hidden md:flex items-center gap-3 pl-2 pr-3 py-1.5 hover:bg-gray-50 rounded-lg cursor-pointer">
                                    <div
                                        className="w-8 h-8 bg-[#00A8E8] rounded-full flex items-center justify-center text-white">
                        ...
                        {/* Mobile Menu */}
                        <button type="button"
                                className="cursor-pointer lg:hidden p-2 text-gray-600 hover:text-[#00A8E8] hover:bg-gray-50 rounded-lg transition-colors ml-2">
